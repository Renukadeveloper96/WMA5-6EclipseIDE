...
@NgModule({
    ...
    providers: [
                ...
                providers: [
                    {
                        ...
                        provider: new GoogleLoginProvider("294281157293-o0jonei653f9k9ab29bd6sug6ln2qhtr.apps.googleusercontent.com", { oneTapEnabled: false }
                        ),

                    },
                    {
                        id: FacebookLoginProvider.PROVIDER_ID,
                        provider: new FacebookLoginProvider("296347169475121")
                    }
                ],
        ...
        PhotoService, ProductService, MenuService, AppBreadcrumbService, ConfigService, MessageService,
        ConfirmationService
    ],
