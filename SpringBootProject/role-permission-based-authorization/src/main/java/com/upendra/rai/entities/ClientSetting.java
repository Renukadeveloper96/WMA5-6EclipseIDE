...
public class ClientSetting {
  ...
  @Lob
  @Column(name = "payment_failure_email_template")
  ...
  @Column(name = "taraweeh_2_label", length = 50)
  private String taraweeh2Label;

  @Column(name = "taraweeh3Label")
  private String taraweeh3Label;

  @Column(name = "taraweeh4Label")
  private String taraweeh4Label;

  @Column(name = "taraweeh5Label")
  private String taraweeh5Label;
  ...
  @Lob
  @Column(name = "primary_communication_emails", length = 5000)
  private String primaryCommunicationEmails;

  @Lob
  @Column(name = "payment_communication_emails", length = 5000)
  private String paymentCommunicationEmails;
  ...
  @JoinColumn(name = "app_slideshow_id")
  private Slideshow appSlideshow;
  ...
  @Column(name = "social_instagram_url", length = 200)
  private String socialInstagramUrl;

  @Column(name = "social_youtube_url", length = 200)
  private String socialYouTubeUrl;

  @Column(name = "web_donation_success_page_url", length = 200)
  private String webDonationSuccessPageUrl;
  ...
  @Column(name = "reply_to_email", length = 128)
  private String replyToEmail;

  @Column(name = "facebook_page_id", length = 200)
  private String faceBookPageId;

  @Column(name = "facebook_access_token")
  private String faceBookAccessToken;

  @Column(name = "instagram_user_id", length = 200)
